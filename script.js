...
function canvasApp() {
    ...
    var message = "뭔가 엄청난일이 남";
    var tickermessage = "\"이게 진짜 뉴스는 맞아요?\" ";
    var img = new Image();
    var imageRatio = "wide";
    ...
    function drawScreen() {
        ...
        //Live
        context.fillStyle = "rgba(19, 82, 164, 1.000)";
        context.fillRect(currentPos.liveBox.x, currentPos.liveBox.y, currentPos.liveBox.w, currentPos.liveBox.h);

        context.font = "700 " + currentPos.liveText.font + " Noto Sans KR";
        context.fillStyle = "#FFFFFF";
        context.fillText('실시간', currentPos.liveText.x, currentPos.liveText.y);
        ...
        // Add colors
        redgrd.addColorStop(0.000, 'rgba(19, 82, 164, 1.000)');
        redgrd.addColorStop(0.015, 'rgba(19, 82, 164, 1.000)');
        redgrd.addColorStop(0.455, 'rgba(19, 82, 164, 1.000)');
        redgrd.addColorStop(0.488, 'rgba(19, 82, 164, 1.000)');
        redgrd.addColorStop(1.000, 'rgba(19, 82, 164, 1.000)');
        ...
        context.font = "700 " + currentPos.breakingText.font + " Noto Sans KR";
        context.fillStyle = "#FFFFFF";
        context.fillText('속보', currentPos.breakingText.x, currentPos.breakingText.y);
        ...
        //Text
        context.font = "700 72px Noto Sans KR";
        ...
        context.font = "700 " + currentPos.clockText.font + " Noto Sans KR";
        context.fillStyle = "#FFFFFF";
        ...
        context.font = "700 " + currentPos.tickerText.font + " Noto Sans KR";
        context.fillStyle = "#000";
        ...
        context.font = "400 " + currentPos.credit.font + " Noto Sans KR";
